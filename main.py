...
images = pipe(
    prompt=prompt, prompt_2=prompt, image=init_image, num_inference_steps=28, strength=0.95, guidance_scale=3.5, 
    gamma=0.5, eta=0.9, start_timestep=0, stop_timestep=6,
).images[0]
